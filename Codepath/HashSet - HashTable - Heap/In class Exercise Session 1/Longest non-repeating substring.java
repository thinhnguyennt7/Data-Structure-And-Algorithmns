/*
Write a program which takes as its input a String and returns the length of the longest
substring that does not contain any repeated characters.

Example: Given the string "abcabcbb", the longest substring with no repeated characters is "abc",

so the program would return a value of 3. Given the string "aaaaaaaa", the longest non-repeating substring is
